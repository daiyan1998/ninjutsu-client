    ...
    <div className="bg-gray-50 py-20 flex flex-col items-center justify-center">
      <div className="xl:w-1/2 w-11/12">
        <h1
          role="heading"
          tabIndex={0}
          className="text-6xl font-bold 2xl:leading-none leading-0 text-center text-gray-800"
        >
      ...
      <div className="2xl:px-20 lg:px-12 px-4 flex justify-center flex-wrap items-start mt-4">
        <div className="mt-24">
